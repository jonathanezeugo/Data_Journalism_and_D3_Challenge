...
The finalized app has been deployed to github page. Click [here](https://jonathanezeugo.github.io/index.html) to or [here](localhost:8000/index.html) view the rendered page.
